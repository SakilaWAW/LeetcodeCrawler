...
class Crawler:
    ...
    def get_page_by_submission_id(self, submission_id):
        ...
        return self.get_code_from_data(submission_page.text.encode(submission_page.encoding).decode('utf-8'))

    @staticmethod
    def get_code_from_data(str_data):
